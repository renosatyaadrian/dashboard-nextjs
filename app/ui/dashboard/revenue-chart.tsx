  ...
  return (
    <div className="w-full md:col-span-4">
      ...
      <div className="rounded-xl bg-gray-200 p-3">
        <div className="sm:grid-cols-13 mt-0 grid grid-cols-13 items-end gap-3 rounded-md bg-white p-8 md:gap-3">
          <div
        ...
        <div className="flex items-center pb-3 pt-6">
          ...
          <h3 className="ml-3 text-sm text-gray-600 ">Last 12 months</h3>
        </div>
      </div>
    </div>
  );
